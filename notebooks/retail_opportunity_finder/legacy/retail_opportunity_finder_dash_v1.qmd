...
This section moves from metro context to tract-level screening. We (1) define the KPIs used in the model, (2) apply eligibility gates that narrow the universe to tracts that match the thesis, and (3) rank eligible tracts with a simple weighted score to identify an initial target set for zone creation.
