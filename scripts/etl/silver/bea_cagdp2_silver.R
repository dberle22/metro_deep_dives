# In this script we normalize BEA CAGDP2 data into our Silver layer
...
DBI::dbWriteTable(con, DBI::Id(schema="silver", table="bea_regional_cagdp2_long"),
                  cagdp2_long, overwrite = TRUE)

DBI::dbWriteTable(con, DBI::Id(schema="silver", table="bea_regional_cagdp2_wide"),
                  cagdp2_wide, overwrite = TRUE)
