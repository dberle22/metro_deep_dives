...
source("visual_library/shared/prep_scatter.R")
source("visual_library/shared/render_scatter.R")
source("visual_library/shared/prep_bar.R")
source("visual_library/shared/render_bar.R")
source("visual_library/shared/prep_choropleth.R")
source("visual_library/shared/render_choropleth.R")
source("visual_library/shared/prep_hexbin.R")
source("visual_library/shared/render_hexbin.R")
source("visual_library/shared/prep_strength_strip.R")
source("visual_library/shared/render_strength_strip.R")
source("visual_library/shared/prep_correlation_heatmap.R")
source("visual_library/shared/render_correlation_heatmap.R")
source("visual_library/shared/prep_highlight_context_map.R")
source("visual_library/shared/render_highlight_context_map.R")
source("visual_library/shared/prep_slopegraph.R")
source("visual_library/shared/render_slopegraph.R")
source("visual_library/shared/prep_heatmap_table.R")
source("visual_library/shared/render_heatmap_table.R")
source("visual_library/shared/prep_age_pyramid.R")
source("visual_library/shared/render_age_pyramid.R")
source("visual_library/shared/prep_bump_chart.R")
source("visual_library/shared/render_bump_chart.R")
source("visual_library/shared/prep_waterfall.R")
source("visual_library/shared/render_waterfall.R")
source("visual_library/shared/prep_bivariate_choropleth.R")
source("visual_library/shared/render_bivariate_choropleth.R")
source("visual_library/shared/prep_proportional_symbol_map.R")
source("visual_library/shared/render_proportional_symbol_map.R")
...
results <- lapply(charts, function(chart) {
  ...
  if (identical(chart_type, "line")) {
    run_result <- run_external_script("visual_library/charts/line/sample_output/test_line_render.R")
